...
| `OPENAI_API_KEY` (optional) | Preferred chatbot provider. If omitted, the chatbot still answers from published dashboard figures. |
| `GEMINI_API_KEY` (optional) | Used when OpenAI is not set. |
